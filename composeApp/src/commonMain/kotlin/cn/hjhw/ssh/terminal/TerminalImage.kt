...
object KittyProtocolParser {
    ...
    private fun parseTransmit(params: Map<String, String>, payload: String): KittyGraphicsCommand.Transmit {
        val format = when (params["f"]?.toIntOrNull()) {
